...
- **Notebook Model_experimentation.ipynb**: this notebook showcases further model exploration and tuning, only on the best performing of the tested models. A GridSearchCV was performed to find the best tuning for both models, Random Forest and XGBoost. Neither performed significangtyl better so the experimentation ended there.
